...
/**
 * Toggle de modo claro/oscuro (next-themes) con el crossfade sol ↔ luna del
 * AnimatedThemeToggle viejo (CSS puro en globals.css, sin framer-motion).
 */
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <Button
      ...
      className={cn("theme-toggle-anim relative", mounted && isDark && "is-dark", className)}
      onClick={() => setTheme(isDark ? "light" : "dark")}
    >
      <svg width="20" height="20" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <g className="theme-toggle-anim__sun">
          <path
        ...
        <path
          className="theme-toggle-anim__moon"
