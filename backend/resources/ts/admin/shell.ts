 ...
 */
import '../shared/admin-table-responsive';
import '../shared/ajax-pagination';
import { getSwal, cf4Toast, cf4Error, cf4Warning } from './shared/swal';
import { bindModalEscapeClose } from './shared/modal-utils';
import { initSidebarAccountMenu } from './sidebar-account-menu';
