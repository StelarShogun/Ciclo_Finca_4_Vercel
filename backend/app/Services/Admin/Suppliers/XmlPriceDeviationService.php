...
class XmlPriceDeviationService
{
    ...
    public function applyUpdates(
        ...
        DB::transaction(function () use (
            ...
            foreach ($updates as $item) {
                ...
                if (! $product) {
                    $this->safeWarning('XmlPriceDeviationService: product not found during applyUpdates', [
                ...
                if ($effectiveSalePrice < $newPurchasePrice) {
                    $this->safeWarning('XmlPriceDeviationService: skipped update — new purchase_price would exceed sale_price.', [
                        'product_id' => $productId,
    ...
    private function safeWarning(string $message, array $context = []): void
    {
        try {
            ...
            // Logging must not break a guarded no-op in the XML review flow.
        }
    }
}
