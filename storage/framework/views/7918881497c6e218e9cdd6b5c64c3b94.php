<?php $__env->startSection('Titulo pagina', 'Registrar Proveedor'); ?>
...
<?php $__env->startSection('contenido'); ?>
    <div class="form-container">
        ...
        <div class="form-card">
            ...
            <form id="formRegistro" class="form-body" action="<?php echo e(route('suppliers.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('suppliers', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/suppliers/create.blade.php ENDPATH**/ ?>