<?php $__env->startSection('Titulo pagina', 'Registrar Usuario'); ?>
...
<?php $__env->startSection('contenido'); ?>
    <div class="formulario-container">
        ...
        <div class="formulario-card">
            ...
            <form id="formRegistro" class="formulario-body" action="<?php echo e(route('usuarios.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('usuarios', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/clients_users/create.blade.php ENDPATH**/ ?>