// @ts-nocheck
import { loadListFragment } from '../../shared/ajax-pagination';
import { syncAllKpiValueScales, syncKpiValueScale, initKpiValueScaleObserver } from '../shared/kpi-value-scale';
import {
    cf4Confirm,
    cf4PromptTextarea,
    cf4Toast,
...
import { closeOtherModals } from '../shared/modal-utils';
import {
    initSaleProductCombobox,
    productRowComboboxMarkup,
} from './sale-product-combobox';
