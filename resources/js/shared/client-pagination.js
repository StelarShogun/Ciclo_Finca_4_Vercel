 ...
 */
function bindClientPaginationToolbar(toolbar) {
    if (!toolbar || toolbar.dataset.cf4ClientPaginationBound === '1') {
        return;
    }
...
export function initClientPagination() {
    document.querySelectorAll('.cf4-pagination-toolbar').forEach(bindClientPaginationToolbar);
}
