                            ...
                            @foreach($cartItems as $item)
                                ...
                                <article class="cart-item" role="listitem" data-product-id="{{ $item['product_id'] }}">
                                    ...
                                    <div class="cart-item-main">
                                        ...
                                        <div class="cart-item-meta">
                                            <span class="item-price">
                                                ...
                                                <span class="item-price-unit">c/u</span>
                                            </span>
                                    ...
                                    <div class="item-controls" aria-label="Cantidad">
                                        <span class="item-controls-label" id="qty-label-{{ $item['product_id'] }}">
                                            Cantidad
                                        </span>
                        ...
                        <aside class="cart-summary" aria-labelledby="cart-summary-title">
                            <div class="summary-card">
                                ...
                                <fieldset class="cart-payment-fieldset">
                                    <legend class="cart-payment-legend" id="cart-payment-legend">
                                        Forma de pago
                                    </legend>

                                    <p class="cart-payment-hint">
                                        Podés cambiarla luego; usamos esto para preparar tu pedido.
                                    </p>

                                    <div
                                        class="cart-payment-options"
                                        role="radiogroup"
                                        aria-labelledby="cart-payment-legend"
                                    >
                    ...
                    <div class="cart-empty">
                        <div class="cart-empty-inner">
                            ...
                            <p class="cart-empty-text">
                                Explorá el catálogo y agregá productos para armar tu solicitud.
                            </p>
                            ...
                            <p class="cart-empty-home-link">
                                <a href="{{ route('clients.home') }}" class="cart-empty-home-anchor">
                                    Volver al inicio
                                </a>
                            </p>
                        </div>
