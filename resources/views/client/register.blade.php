            ...
            <form id="formRegistroCliente" method="POST" action="{{ route('clients.register') }}" novalidate>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="name" name="name"
                        class="form-control @error('name') input-error @enderror" value="{{ old('name') }}"
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="email" id="gmail" name="gmail"
                        class="form-control @error('gmail') input-error @enderror" value="{{ old('gmail') }}"
                ...
                <div class="form-group mb-3">
                    ...
                    <div style="position:relative;">
                        <input type="password" id="password" name="password"
                            class="form-control @error('password') input-error @enderror" minlength="8"
                            placeholder="Mínimo 8 caracteres" autocomplete="new-password" style="padding-right:40px;">
