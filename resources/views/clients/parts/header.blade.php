            ...
            <div class="header-actions">
                ...
                @auth('clients')
                    ...
                    <a href="{{ route('clients.cart') }}"
                       class="cart-btn cart-btn-link" id="cart-link"
                    ...
                    <div class="user-menu-wrap" id="user-menu">
                        ...
                        <div class="user-dropdown-panel" id="user-dropdown"
                ...
                @else
                    ...
                    <button class="cart-btn" id="cart-guest" type="button"
                            data-cart-count="0" title="Ver carrito">
                        <i class="fas fa-shopping-cart"></i>
                    ...
                    @elseif(session('client_id'))
                        ...
                        <form action="{{ route('logout') }}" method="POST"
                              class="logout-form" style="margin:0;">
                            @csrf
                            <button type="submit"
                                    class="user-dropdown-item user-dropdown-logout"
                                    title="Cerrar Sesión">
