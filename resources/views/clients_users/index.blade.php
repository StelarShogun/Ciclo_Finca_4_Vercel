...
<body class="admin-layout">
    ...
    <main class="admin-main">
            ...
            <div class="stat-card">
                <div class="stat-header">
                    <div>
                        ...
                        <p class="stat-value" id="totalUsuarios">{{ $usuarios->total() }}</p>
                    </div>
            ...
            <div class="stat-card">
                <div class="stat-header">
                    <div>
                        ...
                        <p class="stat-value" id="totalClientes">{{ $usuarios->where('rol', 'cliente')->count() }}</p>
                    </div>
            ...
            <div class="stat-card">
                <div class="stat-header">
                    <div>
                        ...
                        <p class="stat-value" id="totalVendedores">{{ $usuarios->where('rol', 'vendedor')->count() }}</p>
                    </div>
            ...
            <div class="stat-card">
                <div class="stat-header">
                    <div>
                        ...
                        <p class="stat-value" id="totalAdmins">{{ $usuarios->where('rol', 'admin')->count() }}</p>
                    </div>
            ...
            <div class="stat-card">
                <div class="stat-header">
                    <div>
                        ...
                        <p class="stat-value" id="totalTecnicos">{{ $usuarios->where('rol', 'tecnico')->count() }}</p>
                    </div>
                ...
                <table class="usuarios-table">
                    ...
                    <tbody id="tablaUsuarios">
                        @forelse($usuarios as $usuario)
                            <tr class="usuario-row" data-rol="{{ $usuario->rol }}" data-usuario-id="{{ $usuario->usuario_id }}">
                                <td>
                                    <div class="user-info">
                                        ...
                                        <div class="user-details">
                                            <h4 class="usuario-nombre">{{ $usuario->nombre }} {{ $usuario->apellido }}</h4>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="actions-container">
                                        <button onclick="verDetalle('{{ $usuario->usuario_id }}')" class="action-btn view" title="Ver detalles">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button onclick="editarUsuario('{{ $usuario->usuario_id }}')" class="action-btn edit" title="Editar usuario">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button type="button" onclick="eliminarUsuario(event, this)" class="action-btn delete" title="Eliminar usuario" data-usuario-id="{{ $usuario->usuario_id }}">
        ...
        <!-- Paginación -->
        <x-pagination :paginator="$usuarios" label="de usuarios" />
