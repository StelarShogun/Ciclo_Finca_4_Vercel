...
@push('styles')
    @vite(['resources/css/admin/shell-base.css', 'resources/css/admin/reports/sales-performance.css'])
@endpush

@push('vite-body')
    @vite(['resources/js/admin/shell.ts', 'resources/js/admin/reports/sales-performance.ts'])
@endpush
...
@section('contenido')
    ...
    <div id="sales-performance-root" class="sales-performance-report"
        data-metrics-url="{{ route('admin.reports.sales.metrics') }}" data-page-url="{{ url('/reports/desempeno-ventas') }}"
        data-initial-preset="{{ e($initialPreset) }}" data-initial-from="{{ e($initialFrom) }}"
        ...
        @component('admin.partials.page-header', ['title' => 'Desempeño de ventas'])
            <p class="sales-performance-lead">
                Analiza las ventas completadas y los ingresos facturados del periodo seleccionado, comparándolos con el periodo
                ...
                <div id="sales-custom-range" class="sales-custom-range" hidden>
                    ...
                    <div class="sales-date-block">
                        ...
                        <div class="sales-date-parts" data-date-group="from">
                            <input type="text" inputmode="numeric" pattern="[0-9]*" maxlength="2" class="sales-num-part"
                                id="sales-from-d" placeholder="DD" aria-label="Día desde" autocomplete="off">
                            <span class="sales-date-sep">/</span>
                            <input type="text" inputmode="numeric" pattern="[0-9]*" maxlength="2" class="sales-num-part"
                                id="sales-from-m" placeholder="MM" aria-label="Mes desde" autocomplete="off">
                            <span class="sales-date-sep">/</span>
                            <input type="text" inputmode="numeric" pattern="[0-9]*" maxlength="4"
                                class="sales-num-part sales-num-part--year" id="sales-from-y" placeholder="AAAA"
                    ...
                    <div class="sales-date-block">
                        ...
                        <div class="sales-date-parts" data-date-group="to">
                            <input type="text" inputmode="numeric" pattern="[0-9]*" maxlength="2" class="sales-num-part"
                                id="sales-to-d" placeholder="DD" aria-label="Día hasta" autocomplete="off">
                            <span class="sales-date-sep">/</span>
                            <input type="text" inputmode="numeric" pattern="[0-9]*" maxlength="2" class="sales-num-part"
                                id="sales-to-m" placeholder="MM" aria-label="Mes hasta" autocomplete="off">
                            <span class="sales-date-sep">/</span>
                            <input type="text" inputmode="numeric" pattern="[0-9]*" maxlength="4"
                                class="sales-num-part sales-num-part--year" id="sales-to-y" placeholder="AAAA"
                ...
                <section id="sales-perf-results" class="sales-perf-results" aria-live="polite">
                    ...
                    <div id="sales-performance-content" class="sales-performance-content" hidden>
                        <div id="sales-empty-state" class="sales-empty-state" hidden>
                            ...
                            <p><strong>No hay ventas completadas</strong> en el periodo elegido. Probá otro rango o revisá
                                más adelante.</p>
                        </div>
                        ...
                        <div class="sales-metrics-compare-wrap">
                            <div class="sales-metrics-column">
                                ...
                                <div class="sales-metrics-grid">
                                    <article class="sales-metric-card">
                                        <div class="sales-metric-icon" aria-hidden="true"><i class="fas fa-receipt"></i>
                                        </div>
                                    ...
                                    <article class="sales-metric-card sales-metric-card--primary">
                                        <div class="sales-metric-icon" aria-hidden="true"><i class="fas fa-coins"></i>
                                        </div>
                            ...
                            <div class="sales-metrics-column sales-metrics-column--previous">
                                <h3 class="sales-col-heading">Periodo anterior <span class="sales-col-heading-note">(misma
                                        duración, para comparar)</span></h3>
                                ...
                                <div class="sales-metrics-grid">
                                    ...
                                    <article
                                        class="sales-metric-card sales-metric-card--secondary sales-metric-card--primary-soft">
                                        <div class="sales-metric-icon" aria-hidden="true"><i class="fas fa-coins"></i>
                                        </div>
                                        <h2 class="sales-metric-title">Ingresos</h2>
                        ...
                        <section class="sales-comparison-section" aria-labelledby="sales-comparison-heading">
                            <h2 id="sales-comparison-heading"
                                class="sales-comparison-heading sales-comparison-heading--subtle">
