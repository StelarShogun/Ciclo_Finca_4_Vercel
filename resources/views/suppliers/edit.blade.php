...
@section('contenido')
    <div class="form-container">
        ...
        <div class="form-card">
            ...
            <form id="formEdicion" class="form-body" action="{{ route('suppliers.update', $supplier->supplier_id) }}"
                method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="primary_contact" name="primary_contact" required
                        value="{{ old('primary_contact', $supplier->primary_contact) }}" placeholder="Ej: María González">
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="tel" id="phone" name="phone" required
                            value="{{ old('phone', $supplier->phone) }}" placeholder="Ej: 88887777">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="address" name="address" required rows="2" placeholder="Ej: San José, 200m norte de la iglesia">{{ old('address', $supplier->address) }}</textarea>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="delivery_time" name="delivery_time" required
                            value="{{ old('delivery_time', $supplier->delivery_time) }}" min="1" max="365"
                            placeholder="Ej: 7">
                    </div>
                    <div class="form-group optional">
                        <label for="rating">Evaluación (0-5)</label>
                        <input type="number" id="rating" name="rating" value="{{ old('rating', $supplier->rating) }}"
